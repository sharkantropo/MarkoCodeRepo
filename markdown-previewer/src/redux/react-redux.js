...
const defData=` Markdown Quick Reference
========================
...
//Action creator
const sendToParse= mark => ({type: PARSE_TEXT, mark});
//Reducer
...
const markStore= createStore(markReducer,marked(defData));
//React-Redux
const mapStatetoProps = (state) =>{return {preview: state}};
const mapDispatchtoProps= (dispatch) =>
{
	return {
		submitNewInput: (newText) => 
		{
			dispatch(sendToParse(newText));
		}
	}
}

export {markStore,mapStatetoProps,mapDispatchtoProps};
